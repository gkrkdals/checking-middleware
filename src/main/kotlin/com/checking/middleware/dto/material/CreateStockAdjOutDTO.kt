...
@Schema(description = "재고조정(출고) DTO")
data class CreateStockAdjOutDTO(
    ...
    @field:Schema(description = "조정구분 (2: 출고)", example = "2")
    val adjustFg: String,

    @field:Schema(description = "입출고구분", example = "2")
    val invFg: String,
    ...
    @field:Schema(description = "비고", example = "출고 조정 비고")
    val remarkDc: String?,
    ...
    @field:Schema(description = "재고조정(출고) 상세")
    val detail: List<CreateStockAdjOutDetail>
)
