...
@Schema(description = "재고조정(입고) 등록 DTO")
data class CreateStockAdjInDTO(
    ...
    @field:Schema(description = "조정구분 (1: 입고)", example = "1")
    val adjustFg: String,

    @field:Schema(description = "입출고구분 (1: 입고)", example = "1")
    val invFg: String,
    ...
    @field:Schema(description = "비고", example = "입고 조정 비고")
    val remarkDc: String?,
    ...
    @field:Schema(description = "재고조정(입고) 상세")
